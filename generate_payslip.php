...
<div class='inline'><strong>Name:</strong> {$row['name']} <strong>Ctrl no:</strong> <span class='text-danger'>309</span></div>
                    ...
                    <table class='table table-bordered'>
                <tr><td><strong>Faculty and Staff Development:</strong></td><td>P " . number_format($row['honorarium'], 2) . "</td></tr>
                <tr><td><strong>GROSS:</strong></td><td><strong>P " . number_format($gross_pay, 2) . "</strong></td></tr>
                <tr><td colspan='2' class='fw-bold'>DEDUCTIONS</td></tr>
                <tr><td>Ret. Plan:</td><td>P " . number_format($row['retirement'], 2) . "</td></tr>
                <tr><td>Medical Savings:</td><td>P " . number_format($row['medical_savings'], 2) . "</td></tr>
                <tr><td>PAG-IBIG Loan:</td><td>P " . number_format($row['pagibig'], 2) . "</td></tr>
                <tr><td>MP2:</td><td>P " . number_format($row['mp2'], 2) . "</td></tr>
                <tr><td>SSS Contri'n:</td><td>P " . number_format($sss_total, 2) . "</td></tr>
                <tr><td>Phil Health:</td><td>P " . number_format($philhealth_total, 2) . "</td></tr>
                <tr><td>PAG-IBIG:</td><td>P " . number_format($pagibig_total, 2) . "</td></tr>
                <tr><td>Absent/Late:</td><td>P " . number_format($row['absent_late_total'], 2) . "</td></tr>
                <tr><td><strong>Total Deduction:</strong></td><td><strong>P " . number_format($total_deduction, 2) . "</strong></td></tr>
                <tr><td><strong>NET PAY:</strong></td><td><strong>P " . number_format($net_pay, 2) . "</strong></td></tr>
                    </table>
                    <div class='signature'>
