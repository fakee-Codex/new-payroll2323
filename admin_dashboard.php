...
if ($result->num_rows > 0) {
    ...
    $employee_count = 0; // Default to 0 if no employees are found
}
...
if ($result->num_rows > 0) {
    ...
    $department_count = 0; // Default to 0 if no departments are found
}
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">GROSS Payroll Projection(OUT)</h6>
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        ...
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Something else
                                        </span>
                                    </div>
                                </div>
                            </div>
